...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='r2l_MSRB_7', help='name of the experiment. It decides where to store samples and models')        
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/home/dj/data/oxford/2019-01-18-15-20-12-radar-oxford-10k/processed') 
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='UNet', help='selects model to use for netG')
        ...
        # radar lidar translation

        self.parser.add_argument('--r2l', type=bool, default=True)
        self.parser.add_argument('--r2l_res', type=int, default=512)

        self.initialized = True

    def parse(self, save=True, opt=None):
