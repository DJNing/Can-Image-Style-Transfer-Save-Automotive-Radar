...
# ---------------------------------------------------------------------------- #
_C.DATA = CN()
_C.DATA.STYLE_IMG_PATH = '/home/dj/Downloads/lidar/nuscene/save_new/lidar/00043.png'              # style image path
_C.DATA.CONTENT_IMG_PATH = '/home/dj/Downloads/lidar/nuscene/save_new/radar/00043.png'         # content image path
_C.DATA.IMG_SIZE = 512
_C.DATA.IMAGENET_MEAN = [0.40760392, 0.45795686, 0.48501961]
# High Resolution Data
_C.HRDATA = CN()
# _C.HRDATA.IMG_SIZE = 800
_C.HRDATA.IMG_SIZE = 512

# ---------------------------------------------------------------------------- #
# Output Configs
# ---------------------------------------------------------------------------- #
_C.OUTPUT = CN()
_C.OUTPUT.DIR = './output/full_transfer/'
